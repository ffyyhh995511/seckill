...
public class JedisClientService {
	...
	private static final String reids_ip = "192.168.11.162";
	...
	public JedisPool getJedisPool(){
		...
		JedisPool jedisPool = new JedisPool(config, reids_ip,redis_port);
		return jedisPool;
	...
	public Long hincrBy(String key, String field,long value){
		...
		try{
			...
			jedis = jedisPool.getResource();
			if(jedis != null){
				rs = jedis.hincrBy(key, field, value);
			}
		}catch(Exception e){
			e.printStackTrace();
		}finally {
...
//		System.out.println(jedisClient.hget("key", "field"));
		...
		//设置库存大小
		jedisClient.set(ConstantCommons.ACCOUNT_KEY, "10000");
